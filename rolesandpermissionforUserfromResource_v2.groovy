...
final JCRCallback callBack = new JCRCallback<Object>() {
    public Object doInJCR(JCRSessionWrapper session) throws RepositoryException {
		...
		log.info ("User '" + username + "' has following global group memberships: " + groupsPathes);
		...
		log.info ("User '" + username + "' has following resource related group memberships: " + groups);
		...
		if (permissions) {
			...
			for (String role : userroles.keySet()) {
				...
				log.info ("Role '" + role + "' has following permissions:");
